...
@Component({
  selector: 'app-new-dds-operation-sheet',
  templateUrl: './new-dds-operation-sheet.component.html',
  styleUrls: ['./new-dds-operation-sheet.component.less']
})
export class NewDdsOperationSheetComponent implements OnInit {
  ...
  constructor(
    @Inject(MAT_BOTTOM_SHEET_DATA) public data: Partial<IDdsDialogData>,
    private goodsService: GoodsService,
    private bottomSheetRef: MatBottomSheetRef<NewDdsOperationSheetComponent>,
  ) {
